...
maine_sarima_fore <- forecast(object = maine_train_sarima_fit, h = fore_h)
...
scores <- as.data.frame(
  rbind(SNAIVE_scores, SARIMA_scores, ETS_scores, ARIMAF_scores)
  )
...
scores <- as.data.frame(
  rbind(TBATS_scores, NN_scores)
  )
row.names(scores) <- c("TBATS", "NN")
